...
## Предупреждение линтера
- TanStack Table's `useReactTable()` API returns functions that cannot be memoized safely - известная проблема https://react.dev/reference/eslint-plugin-react-hooks/lints/incompatible-library
...
11. запусти npm run lint и исправь ошибки ворнинги
